...
namespace RestaurantMenuInfrastructure.Controllers
{
    public class DiscountsController : Controller
    {
        ...
        public DiscountsController(BdrestaurantMenuContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Description,Period,Id")] Discount discount)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Description,Period,Id")] Discount discount)
        {
            if (id != discount.Id)
            {
                return NotFound();
